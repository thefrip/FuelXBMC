    ...
    $.extend($.fn.modal.Constructor.prototype, {
        ...
        loadImage: function () {
            var $this = this,
                ...
                image_type = this.getImageType(this.$links[index]),
                download = this.getDownloadUrl(this.$links[index]),
                oldImg;

            image_width = getCSS('width', image_type);
            image_height = getCSS('height', image_type);
        ...
        showImage: function (img) {
            ...
            modal.find('.modal-title').css({ width: Math.max(image_width, 380) });
            if (transition) {
